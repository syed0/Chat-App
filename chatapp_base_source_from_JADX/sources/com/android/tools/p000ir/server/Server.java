...
import com.android.tools.p000ir.common.ProtocolConstants;
import com.android.tools.p000ir.runtime.ApplicationPatch;
import com.android.tools.p000ir.runtime.PatchesLoader;
...
public class Server {
    ...
    public static Server create(Context context2) {
        return new Server(context2.getPackageName(), context2);
    }

    private Server(String packageName, Context context2) {
    ...
    /* renamed from: com.android.tools.ir.server.Server$SocketServerThread */
    ...
    /* renamed from: com.android.tools.ir.server.Server$SocketServerReplyThread */
    private class SocketServerReplyThread extends Thread {
        private final LocalSocket socket;

        SocketServerReplyThread(LocalSocket socket2) {
            this.socket = socket2;
        }
        ...
        private void handle(DataInputStream input, DataOutputStream output) throws IOException {
            ...
            while (true) {
                ...
                switch (message) {
                    ...
                    case ProtocolConstants.MESSAGE_RESTART_ACTIVITY:
                        if (authenticate(input)) {
                    ...
                    case ProtocolConstants.MESSAGE_SHOW_TOAST:
                    ...
                    case ProtocolConstants.MESSAGE_EOF:
                        if (Log.isLoggable(Logging.LOG_TAG, 2)) {
        ...
        if (updateMode == 0 || updateMode == 1) {
            ...
            if (updateMode == 2) {
                if (activity != null) {
                    ...
                    try {
                        Object result = activity.getClass().getMethod("onHandleCodeChange", new Class[]{Long.TYPE}).invoke(activity, new Object[]{0L});
                        if (Log.isLoggable(Logging.LOG_TAG, 2)) {
